...
def main(argv):
    parser = argparse.ArgumentParser(prog="train_vitasbench_102.py")
    ...
    parser.add_argument("--valid-task", default=None, type=str)
    args = parser.parse_args(argv)

    setproctitle.setproctitle("python train_vitasbench_102.py config: {}; train_dir: {}; cwd: {}"\
    ...
    valid_data = json.load(open(args.valid_pkl, "r"))[args.valid_task]
